...
public class MemberRepository(AppDBContext context) : IMemberRepository
{
    ...
    public async Task<IReadOnlyList<Photo>> GetPhotosForMemberAsync(string id, bool isCurrentUser)
    {
        var query = context.Members.Where(x => x.Id == id).SelectMany(x => x.Photos);
